<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="CityWarningSystem.register" %>
                    ...
                    <div class="bg-white login_content login_border_radius">
                       <div class="form-group row">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    ...
                                    runat="server" ControlToValidate="AadharId" ErrorMessage="Range Must be 12" 
                                    Font-Size="Medium" ForeColor="Red" ValidationExpression="[0-9]{12}"></asp:RegularExpressionValidator>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                               ...
                               <!-- <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                            ControlToValidate="Area" ErrorMessage="Select Area" Font-Size="Medium" 
                                            ForeColor="Red"></asp:RequiredFieldValidator>-->
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
